...
frac exports hooks and utilities from `@usefractal/frac/web` that work across multiple runtimes. See the [compatibility matrix](#runtime-compatibility) below for platform-specific availability.
...
<CardGroup cols={2}>
  ...
  <Card title="useWormhole" icon="radio" href="/api-reference/use-wormhole">
    Connect a widget to live tool-owned state
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="wormhole" icon="route" href="/api-reference/wormhole">
    Create a live state channel between a tool and widget
  </Card>
</CardGroup>
...
| [useWormhole](/api-reference/use-wormhole) | ✅ | ✅ | Requires a wormhole tool result with private connection metadata |

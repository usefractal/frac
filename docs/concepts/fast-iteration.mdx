...
These features are preconfigured in projects created with `pnpm create frac`. If you're adding Frac to an existing app, configure the Vite plugin manually.
</Info>

---
title: Use frac/web
description: "Add React hooks and utilities to your App views with frac/web standalone package."
---

# Use frac/web

This guide shows you how to use `frac/web` without `frac/server` to add React hooks and utilities to your views.
...
`frac/web` provides React hooks and utilities for building advanced Apps:
...
- **[`generateHelpers`](/api-reference/generate-helpers)**: Generate typed helpers for your views (requires `frac/server`)
...
If you're not using `frac/server`, you won't get automatic type inference. You can still add types manually:
